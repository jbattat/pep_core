...
C
  300 IF(IO.GT.0.OR.TAPIN.LE.0) GOTO 305
     ...
     7 ((SCORDA(I,J),I=1,NSITCA),J=1,2),KSITEA,SPCDA,
     8 LSPCDA,NCZNEA,N2A,(LCZHRA(I),I=1,N2A),
     ...
     G NPLN2A,SPOT2A,SPCD2A,LSPC2A,FREQ2A,LEMMNA,
     H NEXTA,((EXNMSA(I,J),I=1,2),J=1,NEXTA),LNGDA,LNFORA,CTLGA,NSKYCA,
     I (LSKYA(I),I=1,NSKYCA),N9A,(LPSRCA(I),I=1,N9A),NMPEXA,NAA,NBA,
     J (NPLEXA(J),(LPEXA(I,J),I=1,NBA),J=1,NAA),T0SITA
      IF(NSITCA.LT.6) THEN
...
C
  305 IF(IO.LT.0.OR.TAPOUT.LE.0) GOTO 990
     ...
     5 ((SCORDA(I,J),I=1,NSITCO),J=1,2),KSITEA,SPCDA,
     6 LSPCDA,NCZNEA,N2A,(LCZHRA(I),I=1,N2A),
     ...
     E NPLN2A,SPOT2A,SPCD2A,LSPC2A,FREQ2A,LEMMNA,
     F NEXT1,((EXNMSA(I,J),I=1,2),J=1,NEXT1),LNGDA,LNFORA,CTLGA,NSKY1,
     G (LSKYA(I),I=1,NSKY1),N9A,(LPSRCA(I),I=1,N9A),NMPEXA,NAA,NBA,
     H (NPLEXA(J),(LPEXA(I,J),I=1,NBA),J=1,NAA),T0SITA
     Z ,(IZERO,I=1,400)
      GOTO 990
C
C        TYPE 4
